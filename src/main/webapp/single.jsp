		...
		<div class="container">
			<div class="product-desc">
				<div class="col-md-7 product-view">
					...
					<p> <i class="glyphicon glyphicon-map-marker"></i><a href="#">state</a>, <a href="#">city</a>|  Product ID: <%= request.getParameter("var") %></p>
				...
				<div class="col-md-5 product-details-grid">
					<div class="item-price">
						<div class="product-price">
							...
							<h3 class="rate"><%= request.getParameter("price") %></h3>
						...
						<div class="itemtype">
							...
							<h4><%= request.getParameter("desc") %></h4>
							<div class="clearfix"></div>
						</div>
					</div>
